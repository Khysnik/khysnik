...
describe('depict syntax', function(){
  ...
  it.skip('has', function() {
    ...
    console.log(divs);    // => is a nodelist
    console.log(divs);    // => has length
    console.log([1]);     // => has length

    var obj = {foo:true,bar:false};
    console.log(obj);     // => has foo
    console.log(obj);     // => has bar
    console.log(obj);     // => has not baz
  })
  ...
  it.skip('pass various stress', function (done) {
  ...
  it.skip('pass multiline', function () {
    /*!
    /test/.constructor.name;
    // 'RegExp'
    /test/;
  ...
  it('use multiple way to parse strings', function() {
