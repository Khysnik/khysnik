...
<div>
  <section>
    <h1>I SORRY</h1>
    <img src="snyan.gif" />
    <br>Refused to display <a target="_blank" href="<?php echo htmlentities($_GET["url"], ENT_QUOTES, 'UTF-8')?>"><?php echo htmlentities($_GET["url"], ENT_QUOTES, 'UTF-8')?></a> in a frame
    <br>because it set 'X-Frame-Options' to 'sameorigin'.
    <br><br><button onclick="window.open('<?php echo htmlentities($_GET["url"], ENT_QUOTES, 'UTF-8')?>', '_blank')">still mad? open it in tab</button>
  </section>
</div>
</body>
</html>
