...
<?php 
  $presets = array (
    ...
    array("sm","fr","tt","rt"),
    array("tf","ec","gd","bt"),
    array("med","mmd","mpd","mrz")
  );
?>
<iframe src="child.html?data=<?php echo $presets[$_GET['preset']][0]?>" id="i0" class="gb"></iframe>
<iframe src="child.html?data=<?php echo $presets[$_GET['preset']][1]?>" id="i1" class="gb"></iframe>
<iframe src="child.html?data=<?php echo $presets[$_GET['preset']][2]?>" id="i2" class="gb"></iframe>
<iframe src="child.html?data=<?php echo $presets[$_GET['preset']][3]?>" id="i3" class="gb"></iframe>
