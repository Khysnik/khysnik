<?php 
  ...
  if ($protocol=='http://') { $port = '8088';}
  if ($protocol=='https://') { 
    $port = '8089';
    $ch = curl_init('https://windows93.net:'.$port);
    ...
    if ($retcode == 200) {
      ...
      echo "<h1>oops!</h1><div>Seems that the https version is down...</div><div>But you can use that one instead: <a href='http://www.windows93.net/trollbox/' target='blank'>http://www.windows93.net/trollbox/</a></div><div>Please drop us a mail if this problem persists: contact@windows93.net</div>";
      die();
    }
    curl_close($ch);
  }
...
<div id="trollbox" class="skin_base ui_layout _ui_unselectable">
  ...
  <script>   
    ...
    var helpMsg =""+
      ...
      "   |    |  \\_  __ \\/  _ \\|  | |  | |    |  _//  _ \\  \\/  /                      \n"+
      "   |    |   |  | \\(  <_> )  |_|  |_|    |   (  <_> >    <                           \n"+
      "   |____|   |__|   \\____/|____/____/______  /\\____/__/\\_ \\ (v2)                  \n"+
      "                                          \\/            \\/                         \n"+
      "––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––--–\n"+
      "| COMMANDS:                                                                         |\n"+
