/*! remarkable 1.7.1 https://github.com/jonschlinkert/remarkable @license MIT */ ! function(e) {
    ...
    return function t(e, r, n) {
        ...
        17: [function(e, t) {
            ...
            function n(e) {
                ...
                return r = i.replaceEntities(r), -1 !== r.indexOf(":") && -1 !== t.indexOf(r.split(":")[0]) ? !1 : !0
            }
            var s = e("./ruler"),
        ...
        18: [function(e, t) {
            ...
            var n = e("./common/utils"),
                s = e("./rules");
            t.exports = r, r.prototype.renderInline = function(e, t, r) {
        ...
        20: [function(e, t) {
            ...
            l.blockquote_open = function() {
                ...
                var u, p, h, f = e[t],
                    ...
                    m = "";
                if (f.params) {
                    if (u = f.params.split(/\s+/g), p = u.join(" "), n(c.rules.fence_custom, u[0])) return c.rules.fence_custom[u[0]](e, t, r, l, c);
        ...
        30: [function(e, t) {
            ...
            t.exports = function(e, t, o, i) {
                ...
                for (y = e.tokens.length, k ? (f = e.bMarks[t] + e.tShift[t], b = Number(e.src.substr(f, d - f - 1)), e.tokens.push({
                        ...
                        lines: A = [t, 0],
                        level: e.level++
                    }), u = e.blkIndent, p = e.tight, c = e.tShift[t], h = e.parentType, e.tShift[t] = _ - e.bMarks[t], e.blkIndent = a, e.tight = !0, e.parentType = "list", e.parser.tokenize(e, t, o, !0), (!e.tight || x) && (M = !1), x = e.line - t > 1 && e.isEmpty(e.line - 1), e.blkIndent = u, e.tShift[t] = c, e.tight = p, e.parentType = h, e.tokens.push({
        ...
        33: [function(e, t) {
            ...
            t.exports = function(e, t, n, s) {
                ...
                for (h = [], a = 0; a < u.length; a++) {
                    ...
                    if (!/^:?-+:?$/.test(f)) return !1;
                    h.push(58 === f.charCodeAt(f.length - 1) ? 58 === f.charCodeAt(0) ? "center" : "right" : 58 === f.charCodeAt(0) ? "left" : "")
                }
                if (i = r(e, t).trim(), -1 === i.indexOf("|")) return !1;
                if (u = i.replace(/^\||\|$/g, "").split("|"), h.length !== u.length) return !1;
                if (s) return !0;
                for (e.tokens.push({
                        type: "table_open",
                        lines: d = [t, 0],
                ...
                for (e.tokens.push({
                    ...
                    for (u = i.replace(/^\||\|$/g, "").split("|"), e.tokens.push({
                        ...
                        align: h[a],
                        level: e.level++
                    }), p = u[a].substring(124 === u[a].charCodeAt(0) ? 1 : 0, 124 === u[a].charCodeAt(u[a].length - 1) ? u[a].length - 1 : u[a].length).trim(), e.tokens.push({
                        type: "inline",
                        content: p,
                        level: e.level,
                        children: []
        ...
        53: [function(e, t) {
            ...
            t.exports = function(e, t) {
                ...
                if (p = l + 1, m > p && 40 === e.src.charCodeAt(p)) {
                    ...
                    if (m > p && 91 === e.src.charCodeAt(p) && (b = p + 1, p = r(e, p), p >= 0 ? a = e.src.slice(b, p++) : p = b - 1), a || ("undefined" == typeof a && (p = l + 1), a = e.src.slice(i, l)), h = e.env.references[o(a)], !h) return e.pos = g, !1;
                    c = h.href, u = h.title
                }
