...
# 3.2.2
# Olivier
#			=> Changement de la gestion des URL sp�ciales
#
# 3.2.1
# Olivier
...
class wiki2xhtmlBasic
{
	...
	function wiki2xhtml()
	{
		...
		$this->setOpt('active_empty',1);		# Activation du bloc vide ���
	...
	function __getMacro($s)
	{
		...
		return '���##########MACRO#'.(count($this->macros)-1).'#';
	}
