...
class wiki2xhtmlChu extends wiki2xhtmlBasic
{
	...
	function wiki2xhtmlChu()
	{
		...
		$this->setOpt('active_deflists',1);		# Activation des listes de d�finitions
		...
		$this->setOpt('parse_pre',0);			# Parser l'int�rieur de blocs <pre> ?
